...
// Handler stubs - full implementation in handlers.go (Task 14)
func (b *Bot) handleStart(c tele.Context) error {
	return c.Send("TeleClaude bot starting...")
}
...
func (b *Bot) handleNew(c tele.Context) error {
	return c.Send("Not yet implemented")
}
...
func (b *Bot) handleProjectSelect(c tele.Context) error {
	return c.Respond(&tele.CallbackResponse{Text: "Not yet implemented"})
}
